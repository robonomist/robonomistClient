...
- Add
  [`fetch_data_from_url()`](https://robonomist.github.io/robonomistClient/reference/fetch_data_from_url.md)
  function to help data fetching from statistical websites
...
- Remove dependency on stats::install.packages() and tempdir() to allow
  caching
...
- Print more row by default for robonomist_search and
...
- Change to serializer from `qs` package, `fst` consumed too much memory
  on large datasets.
