...
You can also fetch data simply by copying the link from your browser and passing it to the `data()` function. For example, if you find a dataset on the OECD website, you can retrieve it like this:
