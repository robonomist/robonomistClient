...
Once installed, set your Robonomist Server's address option `robonomist.server`. Now can start exploring the database. 
...
You can also export the data, for example to an [Excel file](../blob/main/README_files/export.xlsx):
